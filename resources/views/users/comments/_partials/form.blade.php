<div class="w-full bg-white rounded px-8 py-12 mt-4">
  ...
  <textarea name="body" id="body" rows="5" class="bg-gray-50 appearance-none border border-gray-100 rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none my-2" placeholder="Comentário"></textarea>
  <label for="visible">
